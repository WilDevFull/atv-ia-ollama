...
2. **Matemática:** Se identificar uma operação matemática, ele aciona a `Calculadora` personalizada, executa a equação e formula a resposta final.

## 🚀 Como Executar Localmente
1. Instale o [Ollama](https://ollama.com/) e baixe o modelo leve (ex: `ollama run llama3.2` ou `ollama run phi3`).
